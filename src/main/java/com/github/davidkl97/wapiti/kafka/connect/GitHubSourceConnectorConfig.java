...
import com.github.davidkl97.wapiti.kafka.connect.Validators.BatchSizeValidator;
import com.github.davidkl97.wapiti.kafka.connect.Validators.TimestampValidator;
...
public class GitHubSourceConnectorConfig extends AbstractConfig {
    ...
    private static final String REPO_DOC = "Repository to follow";
    private static final String SINCE_DOC = "Get All Issues from the date specified.\n"
            + "Timestamp in ISO 8601 format;\n"
            + "Defaults to a year from first launch.";
    private static final String BATCH_SIZE_DOC = "Number of data to retrieve at a time. defaults to 100";
